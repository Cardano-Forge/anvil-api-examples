  ...
  outputs: [
    {
      ...
      datum: {
        type: "inline",
        value: {
          owner: customer.stake_key_hash, // Only the Customer stake key will be able to unlock the funds
        },
        shape: {
          validatorHash: hash,
          purpose: "spend",
...
// Need to sign with the UTXO key (the payment address that sent the UTXO and pays the fee).
txToSubmitOnChain.sign_and_add_vkey_signature(
  PrivateKey.from_bech32(customer.skey), // sign with payment key
);
